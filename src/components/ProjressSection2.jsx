...
const ProjressSection2 = () => {
  ...
  return (
    <section className='align-element mt-10 sm:mt-24 grid lg:grid-cols-2 gap-3 sm:gap-5 '>
      {/* images */}
      <div className='relative  lg:col-span-1 h-96 '>
        <motion.div
      ...
      {/* Projress */}
      <div className='flex flex-col gap-3 sm:gap-5 lg:col-span-1'>
        <TwoTitles
